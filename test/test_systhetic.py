...
parser.add_argument('--input_dir', default='../../../multiple-dataset/testing/',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/multi_256/',
...
with torch.no_grad():
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        # flops = FlopCountAnalysis(model_restoration, rgb_noisy)
        # print("FLOPs: ", flops.total())
        # print("params:", parameter_count_table(model_restoration))
        rgb_noisy = F.upsample(rgb_noisy, [384, 384],
                       mode='bilinear')
        with torch.cuda.amp.autocast():
            rgb_restored = model_restoration(rgb_noisy)
        rgb_restored = F.upsample(rgb_restored, [400, 400],
                               mode='bilinear')
